...
def checkMonth(id_tipo,month):
    query="select count(id), tipo_mascota_id from mascota_domicilio where domicilio_id in (select id from domicilio where extract(month from fecha_ingreso)=%s) and tipo_mascota_id=%s;"

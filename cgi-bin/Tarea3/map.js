...
// empieza en Santiago
let mymap = L.map('mapid').setView([-33.4500000, -70.6666667], 13);
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1IjoibGlua3IiLCJhIjoiY2todGljdmhlMG5raDJ4bXQwOXZhajh6ZCJ9.c0Y3mCCQhnzVU2KyxQ4ung'
}).addTo(mymap);
...
function onMarkerClick(e, comuna) {
    ...
    xhr.onload = (data) => {
        ...
        console.log(info);
        if (info.length === 0) {
            content = "Aún no hay censos de esta comuna.";
